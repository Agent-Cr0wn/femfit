              ...
              <div className="radio-group">
                ...
                <label className="radio-label">
                  <input 
                    ...
                    name="goal" 
                    value="body_recovery" 
                    checked={formData.goal === 'body_recovery'} 
                    onChange={handleChange} 
                  />
                  Body Recovery
                </label>
              ...
              <div className="radio-group">
                <label className="radio-label">
                  <input 
                    ...
                    onChange={() => setFormData({...formData, is_pregnant: true})} 
                  />
                  Currently Pregnant
                </label>
                <label className="radio-label">
                  <input 
                    ...
                    onChange={() => setFormData({...formData, is_pregnant: false})} 
                  />
                  New Mother (Post-pregnancy)
                </label>
              </div>
            </div>
          </>
  ...
  return (
    <div className="container questionnaire-container">
      <div className="questionnaire-header">
        <h2>Create Your Personalized Mother's Fitness Plan</h2>
        <p>{formData.is_pregnant ? "Safe and effective workouts for your pregnancy journey." : "Get your body back with workouts designed for new mothers."}</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="questionnaire-form">
        ...
        <div className="form-navigation">
          ...
          {step < 5 ? (
            ...
            >
              {isSubmitting ? 'Creating Your Plan...' : 'Create My Mother\'s Fitness Plan'}
            </button>
          )}
        </div>
      </form>
...
export default MothersQuestionnaire;